...
{
    /**
     * Affiliate member tmp image path
     * 
     * @var string
     */
    const AFFILIATEMEMBER_IMAGE_TMP_PATH = 'zb_affiliatemember/tmp/affiliatemember/image';

    /**
     * Affiliate member image path
     * 
     * @var string
     */
    const AFFILIATEMEMBER_IMAGE_PATH = 'zb_affiliatemember/affiliatemember/image';
