 ...
 */
namespace Zb\AffiliateMember\Model\ResourceModel;
...
class Affiliatemember extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    {
        $this->_init('zb_affiliatemember_affiliatemember', 'affiliatemember_id');
    }

    /**
     * Retrieves Affiliate member Name from DB by passed id.
     *
     * @param string $id
     * @return string|bool
     */
    public function getAffiliatememberNameById($id)
    {
        $adapter = $this->getConnection();
        $select = $adapter->select()
            ->from($this->getMainTable(), 'name')
            ->where('affiliatemember_id = :affiliatemember_id');
        $binds = ['affiliatemember_id' => (int)$id];
     ...
     *
     * @param \Magento\Framework\Model\AbstractModel|\Zb\AffiliateMember\Model\Affiliatemember $object
     * @return $this
     */
